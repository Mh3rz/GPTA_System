...
if (isset($_POST['submitted'])) {
    ...
    if (mysqli_query($conn, $sql)) {
        $stat = 'deactivated';
        header("Location: update_list.php?id='".$newsectionid."'&stat=".$stat. "&page=" . $currentPage ."&message=". $row['lastname'] .", ".$row['firstname']." ". $row['m_i'].", Records has been <b>Deactivated</b>");
    } else {
