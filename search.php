                ...
                <div class="table-wrapper">
                    ...
                    ?>
                        ...
                        <?php
                            ...
                            // Retrieve all records from the student_lists table where active is equal to 0
                            $sql = "SELECT * FROM student_lists WHERE active = 0 ORDER BY lastname";
                        ...
                        ?>
                    <div class="table_container" style="background-color: #fff; padding:20px; height: 100%; border-radius: 15px;" >
                                ...
                                <div class="input-group">
                                    <?php if (!empty($searchQuery)) : ?>
                                        <div class="input-group-append">
                                            <a href="search.php" class="btn btn-outline-secondary me-2">clear</a>
                                        </div>
                                    <?php endif; ?>
                        ...
                        ?>        
                                ...
                                <tr>
                                    ...
                                    <th class="col-1 text-center">Room</th>
                                ...
                                foreach ($paginatedRows as $row) {
									...
									echo '<button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action</button>';
									echo '<ul class="dropdown-menu">';
									if ($row['status'] == 1 || $row['status'] == 2) {
										echo '<li><button type="button" id="'. $row['id'].'" class="dropdown-item text-secondary fw-bold" data-toggle="modal" data-target="#myModalchange_'.$row['id'].'"><i class="bi bi-arrow-left-right me-2"></i>Change</button></li>';
									} else {
										echo '<li><button type="button" id="'. $row['id'].'" class="dropdown-item text-success fw-bold" data-toggle="modal" data-target="#myModal_'.$row['id'].'"><i class="bi bi-cash me-2"></i>Payment</button></li>';
									}
                                    echo '<li><button type="button" id="'. $row['id'].'" class="dropdown-item text-primary fw-bold" data-toggle="modal" data-target="#myModal_update_'.$row['id'].'"><i class="bi bi-pencil-square me-2"></i>Update</button></li>';
                                    echo '<li><button type="button" id="'. $row['id'].'" class="dropdown-item text-danger fw-bold" data-toggle="modal" data-target="#myModaldeactivate_'.$row['id'].'"><i class="bi bi-x-octagon me-2"></i>Deactivate</button></li>';
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body" id="modal-body">
                                                    <form action="payment_process_search.php" method="post">
                                    ...
                                    <div class="modal fade" id="myModalchange_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body" id="modal-body">
                                                    <form action="change_payment_process_search.php" method="post">
                                    ...
                                    <!-- Modal Deactivate-->
                                    <div class="modal fade" id="myModaldeactivate_<?php echo $row['id']; ?>" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body" id="modal-body">
                                                    <form action="deactivate_process_search.php" method="post">
                                                        <label for="name"><?php echo $row['lastname'].", ".$row['firstname']." ". $row['m_i']; ?></label>
                                                        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                                        <input type="hidden" name="page" value=<?php echo $currentPage; ?>>
                                                        <input type="hidden" name="search" value="<?php echo $searchQuery; ?>">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="update_search.php" method="POST" class="container" id="insertForm">
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="form-group">
                                                                    <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                            ...
                            $visiblePages = 4;
                            $halfVisible = floor($visiblePages / 4);

                            for ($i = 1; $i <= $totalPages; $i++) {
                                if ($i == 1 || $i == $totalPages || ($i >= $currentPage - $halfVisible && $i <= $currentPage + $halfVisible)) {
                                    echo '<li class="page-item ' . ($i == $currentPage ? 'active' : '') . '"><a class="page-link" href="?&search='.$searchQuery.'&page=' . $i . '">' . $i . '</a></li>';
